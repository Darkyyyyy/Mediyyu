...
contextBridge.exposeInMainWorld('winControls', {
  ...
  nativeWindowButtons: process.platform === 'darwin',
  onFullScreenChange: (cb) => ipcRenderer.on('win:fullscreen', (e, on) => cb(on)),
  ...
  onRecovered: (cb) => ipcRenderer.on('app:recovered', () => cb()),
  ...
  fileExists: (path) => ipcRenderer.invoke('files:exists', path),
  exportPreset: (fileName, text) => ipcRenderer.invoke('preset:export', { fileName, text }),
  onOpenPreset: (cb) => ipcRenderer.on('preset:open', (e, payload) => cb(payload)),
  presetWinData: () => ipcRenderer.invoke('presetwin:data'),
  presetWinFit: (height) => ipcRenderer.send('presetwin:fit', height),
  presetWinOpenApp: () => ipcRenderer.send('presetwin:openApp'),
  scanDirForAudio: (p, recursive, limit) => ipcRenderer.invoke('files:scanDir', p, recursive, limit),
  folderImages: (dirs) => ipcRenderer.invoke('library:folderImages', dirs),
  libraryDurations: (paths) => ipcRenderer.invoke('library:durations', paths),
